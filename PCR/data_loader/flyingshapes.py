...
class FlyingShapes(Dataset):
    ...
    def __init__(
        ...
        super(FlyingShapes, self).__init__()
        ...
        if self.subset == "train":
            self.metadata_root = osp.join(self.dataset_root, "FlyingShapes")
            self.data_root = osp.join(self.dataset_root, "FlyingShapes")
