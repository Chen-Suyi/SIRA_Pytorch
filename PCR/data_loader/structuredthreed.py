...
class StructuredThreeD(Dataset):
    ...
    def __init__(
        ...
        super(StructuredThreeD, self).__init__()
        ...
        if self.subset == "train":
            self.metadata_root = osp.join(self.dataset_root, "Structured3D")
            self.data_root = osp.join(self.dataset_root, "Structured3D")
            ...
            with open(osp.join(self.metadata_root, gt_log), "r") as f:
                for line in f.readlines():
                    ...
                    if scene_index not in self.train_index_list:
                        ...
                        data["scene_name"] = "scene_{:05d}".format(scene_index)
            ...
            with open(osp.join(self.metadata_root, f"{subset}.pkl"),
                      "rb") as f:
